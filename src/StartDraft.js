...
return(
  ...
  <SettingsButtons text={"Number of Cards Per Pack"} setSetting={setCardsPerPack} values={[2,5,10]} artwork={1}/>
  <SettingsButtons text={"Number of Packs Per Draft"} setSetting={setNumberOfPacks} values={[2,5,10]} artwork={2}/>
  <SettingsButtons text={"Number of Extra-Packs Per Draft"} setSetting={setExtraDeckPacks} values={[2,5,10]} artwork={3}/>
